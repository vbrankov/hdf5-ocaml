...
external make_dataset_float32         : Loc.t -> string -> (float    , float32_elt       , _) Genarray.t -> unit = "hdf5_h5lt_make_dataset_float"
external make_dataset_float64         : Loc.t -> string -> (float    , float64_elt       , _) Genarray.t -> unit = "hdf5_h5lt_make_dataset_double"
