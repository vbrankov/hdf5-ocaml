...
value Val_h5o_hdr_info(H5O_hdr_info_t hdr_info)
{
  CAMLparam0();
...
value Val_h5o_info(H5O_info_t info)
{
  CAMLparam0();
  ...
  Store_field(info_v, 1, caml_copy_int64(info.addr));
