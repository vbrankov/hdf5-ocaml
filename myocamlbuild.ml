(* OASIS_START *)
(* DO NOT EDIT (digest: c65db0a0b978a5ca5f072a594f04ba72) *)
...
let package_default =
  {
     ...
     flags =
       [
          ...
          (["oasis_executable_test_struct_byte"; "ocaml"; "link"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-ppx"; A "lib/ppx/ppx_h5struct.native"])
            ]);
          (["oasis_executable_test_struct_native"; "ocaml"; "link"; "native"],
            [
               (OASISExpr.EBool true,
                 S [A "-ppx"; A "lib/ppx/ppx_h5struct.native"])
            ]);
          (["oasis_executable_test_struct_byte"; "ocaml"; "ocamldep"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-ppx"; A "lib/ppx/ppx_h5struct.native"])
            ]);
          ([
              "oasis_executable_test_struct_native";
              "ocaml";
              "ocamldep";
              "native"
           ],
          ...
          (["oasis_executable_test_struct_byte"; "ocaml"; "compile"; "byte"],
            [
               (OASISExpr.EBool true,
                 S [A "-ppx"; A "lib/ppx/ppx_h5struct.native"])
            ]);
