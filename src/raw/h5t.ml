...
external get_member_class : Hid.t -> int -> Class.t = "hdf5_h5t_get_member_class"
external get_member_name : Hid.t -> int -> string = "hdf5_h5t_get_member_name"
external get_member_type : Hid.t -> int -> Hid.t = "hdf5_h5t_get_member_type"
external is_variable_str : Hid.t -> bool = "hdf5_h5t_is_variable_str"
external insert : Hid.t -> string -> int -> Hid.t -> unit = "hdf5_h5t_insert"
external vlen_create : Hid.t -> Hid.t = "hdf5_h5t_vlen_create"
