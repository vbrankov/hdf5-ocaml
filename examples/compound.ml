...
let () =
  ...
  H5d.write dataset s1_tid ~mem_space:H5s.all ~file_space:H5s.all (genarray_of_array1 s1);
  H5t.close s1_tid;
  H5s.close space;
  H5d.close dataset;
  H5f.close file;
  ...
  H5d.read dataset s2_tid ~mem_space:H5s.all ~file_space:H5s.all
    (genarray_of_array1 s2.S2.t0);
  ...
  H5d.read dataset s3_tid ~mem_space:H5s.all ~file_space:H5s.all (genarray_of_array1 s3);
