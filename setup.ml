...
(* OASIS_START *)
(* DO NOT EDIT (digest: 715e59fa35f4e43ddb71cace9f72b966) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_struct",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_struct", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Field"; "H5"; "Struct"; "Struct_intf"; "Type"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = None;
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_struct.ml"});
               Test
                 ({
                     cs_name = "test_struct";
                     cs_data = PropList.Data.create ();
                      ...
                      Some
                        (("bash",
                           [
                              ...
                              "ln";
                              "-s";
                              "ppx_h5struct.4.02.ml";
                              "lib/ppx/ppx_h5struct.ml\nelse\n";
                              "ln";
                              "-s";
                              "ppx_h5struct.4.03.ml";
                              "lib/ppx/ppx_h5struct.ml\nfi'"
                           ])))
                 ]
            };
     ...
     oasis_digest = Some "\153\225\246(t\253\218#\240\001\007);\243G\178";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
